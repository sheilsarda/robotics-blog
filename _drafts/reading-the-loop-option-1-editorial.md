...
visual_variant: "option-1-editorial"
draft: true
---
...
![Rate stack ladder: where each company closes the control loop](../assets/posts/model-scorecards/option1/rate-stack-ladder.png)
...
![Public disclosure scorecard across five robot foundation model companies](../assets/posts/model-scorecards/option1/disclosure-heatmap.png)
...
![Real-time chunking: generating the next action chunk during execution](../assets/posts/model-scorecards/option1/rtc-timing.png)
...
![Two camps: inference economics versus data economics](../assets/posts/model-scorecards/option1/two-camp-split.png)
...
![Falsifiable gate: what DreamZero settled and what remains open](../assets/posts/model-scorecards/option1/falsifiable-gate.png)
